          ...
          <div className='flex flex-col gap-[10px]'>
            {providers.map((provider: any) => {
              return (
                <div
                  key={provider.type}
                  className='flex w-full cursor-pointer items-center justify-center gap-[10px] rounded-[12px] bg-background py-[10px] text-[14px] font-medium shadow-sm shadow-black/5 hover:opacity-70 active:scale-[0.98] active:opacity-60'
                  onClick={() => {
                    router.push(
