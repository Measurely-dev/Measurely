          ...
          <div className="flex flex-col gap-[10px]">
            {providers.map((provider, i) => {
              return (
                <div
                  key={i}
                  className="flex w-full curso-pointer items-center justify-center gap-[10px] rounded-[12px] bg-background py-[10px] text-[14px] font-medium transition-all hover:bg-background/75 cursor-pointer"
