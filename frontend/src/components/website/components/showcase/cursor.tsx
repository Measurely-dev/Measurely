...
function cursor3(className: string) {
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="w-fit rounded-[100px_100px_100px_20px] border-[1.5px] bg-background p-1 px-2 text-sm bg-gradient-to-r from-purple-500 via-blue-500 to-pink-400 text-transparent bg-clip-text animate-gradient">
        Click here
      </div>
    </div>
  );
