        ...
        Nav: ({ className, ...props }) => {
          ...
          return (
            <nav className={cn('flex items-center', className)} {...props}>
              <Button
                variant='secondary'
                className='absolute left-0 h-7 w-7 bg-accent p-0 opacity-80 hover:opacity-100'
                type='button'
              ...
              <Button
                variant='secondary'
                className='absolute right-0 h-7 w-7 bg-accent p-0 opacity-80 hover:opacity-100'
                type='button'
...
MetricDatePicker.displayName = 'Metric date picker';

export { MetricDatePicker };
