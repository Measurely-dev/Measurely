    ...
    >
      <div className="flex flex-col gap-[5px]">
        ...
        <div className="text-xs text-secondary">
          This is how people in your team (coming soon) see’s you
        </div>
      </div>
      <div className="flex w-full flex-row items-center justify-between">
        <div className="flex flex-row items-center gap-5">
          <Avatar className="relative size-[65px] items-center justify-center overflow-visible border">
          ...
          <div className="flex flex-col gap-[2px]">
            ...
            <div className="text-xs text-secondary">
              {props.email === "" ? (
                <Link href='/dashboard/settings' className="cursor hover:text-blue-500">Add your email in the settings</Link>
              ) : (
                props.email
              )}
            </div>
        ...
        <Button className="rounded-[12px]">View settings</Button>
      </div>
    </Card>
  );
}
