...
export function CodeComparison({
  ...
  return (
    <div className='mx-auto w-full max-w-5xl max-md:hidden'>
      <div className='relative w-full overflow-hidden rounded-xl border border-border shadow-sm shadow-black/5'>
        <div className='relative grid md:grid-cols-2 md:divide-x md:divide-border'>
          <div>
            <div className='flex items-center bg-accent p-2 px-4 text-sm text-foreground'>
              <FileCode2 className='mr-2 h-4 w-4' />
              {filename}
              <span className='ml-auto text-muted-foreground'>before</span>
            </div>
          ...
          <div>
            <div className='flex items-center bg-accent p-2 text-sm text-foreground'>
              <FileCode2 className='mr-2 h-4 w-4' />
              {filename}
              <span className='ml-auto text-muted-foreground'>after</span>
            </div>
