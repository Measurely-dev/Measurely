      ...
      <WebContainer>
        <ContentContainer className="min-h-screen">
          <div className="flex flex-col gap-5 my-auto mx-auto">
            <Link href="/home">
              <div className=" max-md:text-3xl max-sm:text-2xl text-5xl font-mono relative justify-center items-center font-bold hover:gap-5 duration-200 transition-all cursor-pointer hover:opacity-65 flex gap-2">
                404 Page Not Found <ArrowRight className="size-12" />
                <ShowcaseCursor cursor={3} className="!absolute max-lg:left-[-75px] max-sm:hidden -top-14 left-[-125px]" />
              </div>
            </Link>
          </div>
        </ContentContainer>
