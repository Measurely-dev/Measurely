...
export default function Help() {
  ...
  return (
    <WebContainer>
      <ContentContainer className="min-h-[600px] h-screen">
        <Card className="max-w-[400px] w-full mx-auto my-auto !rounded-2xl px-2 border-none !pb-20">
          <CardHeader className="!m-0 p-0">
            <CardTitle className="text-2xl"> Do you need help?</CardTitle>
          </CardHeader>
          <CardContent className="flex flex-col gap-2 w-full !p-0 mt-5">
            {help.map((help, i) => {
              return (
                <div
                  key={i}
                  className="flex w-full py-2.5 pr-4 transition-all duration-200 group items-center px-6 gap-2 rounded-xl hover:opacity-80 cursor-pointer justify-between bg-accent"
                  style={{ backgroundColor: help.color }}
                >
                  {help.icon}
                  <ArrowUpRight
                    className="size-5 transition-all duration-200 text-white group-hover:mr-1"
