...
The value of a Basic Metric is always positive. This is because Basic Metrics track a singular value, and any changes to this value represent increments, counts, or other positive measurements. If you need to track both positive and negative values, consider using a **Dual Metric** instead
</Note>
