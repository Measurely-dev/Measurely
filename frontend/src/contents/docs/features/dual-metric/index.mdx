...
<Stepper>
  ...
  <StepperItem title='Step 2: Click Create Metric'>
    ...
    **Dual Metric**. Choose **Dual Metric**.
  </StepperItem>
  ...
  <StepperItem title='Step 4: Define Variable Names (optional)'>
    Define separate variable names for your positive and negative values (e.g.,
    "Accounts Created" for positive, "Account Deleted" for negative).
  </StepperItem>
  <StepperItem title='Step 5: API KEY Integration'>
