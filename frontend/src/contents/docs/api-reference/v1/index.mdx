...
To interact with the Measurely API, you need to send a POST request to the endpoint with an project API key and the metric ID of the value you wish to update. Follow the steps below to understand how to use the API.
...
<Tabs defaultValue="go" className="pt-5 pb-1">
  ...
  <TabsContent value="go">
    ...
    func updateMetric(API_KEY string, METRIC_ID string, value int) (int, error) {
      ...
      req.Header.Set("Content-Type", "project/json")
